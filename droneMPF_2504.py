...
#####Extract LOG data
csv_path = "data/log/log_25052025.csv"  # Replace with your actual path
# start_idx = 1306  #for itu video2
# end_idx   = 2622
start_idx = 839  #for itu winter
end_idx   = 3839
...
pos0 = np.array([n, e + 8, data_dict['XKF']['PD'][0]])  # initial position relative to the left upper corner of the map
...
time_offset = 145     #initilize video cam at 5th second(which is altitude is constant for itu winter video)
...
isPreprocessedVideoFake = False
videoName = 'itu_winter.mp4'
hUAVCamera = UAVCamera(FeatureDM = hFeatureDM, dt = 0.8*dt, snap_dim = snap_dim, fps = fps, cropFlag = True, 
