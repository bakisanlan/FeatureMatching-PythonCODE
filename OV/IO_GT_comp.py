...
date = 183452
ref_traj = np.load('logs/generated_traj_20250705-{}.npy'.format(date), allow_pickle=True)
GPS_pos  = np.load('logs/GT_pos_list_20250705-{}.npy'.format(date), allow_pickle=True)
VIO_pos  = np.load('logs/VIO_pos_list_20250705-{}.npy'.format(date), allow_pickle=True)

visualize2DgenTraj(ref_traj, GPS_pos, VIO_pos)


# filepath = 'logs/pos_controller_test_with_odom_20250705-141035.txt'
