...
## wp navigation
v_max = 10
traj = TrajectoryGeneratorV2(sampling_freq=1/controller_dt, max_vel=[v_max, v_max, v_max], max_acc=[5.0, 5.0, 5.0])
...
while True:
    ...
    if  node_OdomVIO.first_gt_odom_msg and node_OdomVIO.first_gps_fix_msg and node_OdomVIO.first_state_msg:
        ...
        if is_first_messages:
            ...
            yaw_diff = yaw_diff_finder(node_OdomVIO.gt_odom_dict.copy(), node_OdomVIO.gt_odom_dict.copy())

            # Initialize yaw vector from GPS/mag/inital guess 
            VIO_dict = ned_VIO_converter(node_OdomVIO.gt_odom_dict.copy(), yaw_diff, is_velocity_body = False)
